...
namespace Calloatti.HousingTweaks
{
  ...
  {
    // Regex to safely extract MaxBeavers despite JSON spacing variations
    private static readonly Regex CapacityRegex = new Regex(@"\""MaxBeavers\""\s*:\s*(\d+)", RegexOptions.Compiled);
